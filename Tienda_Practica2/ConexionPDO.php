...
//    }
     ...
     * @return type
     */
    public static function muestraVlores(string $nombreTabla): array {
...
//        $consulta->execute();
     ...
     * @return type
     */
    public static function buscaValor(array $key, string $nameTable, $id) {

        $consulta = ConexionPDO::conectar()->prepare("select * from $nameTable where $key[0] ='$id'");
        $consulta->execute();
        while ($f = $consulta->fetch(PDO::FETCH_ASSOC)) {
            return $f;
        }
