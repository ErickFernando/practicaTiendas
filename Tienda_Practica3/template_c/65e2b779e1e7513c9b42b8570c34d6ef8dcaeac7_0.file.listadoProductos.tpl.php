...
function content_5c651d9beb06c5_57618036 (Smarty_Internal_Template $_smarty_tpl) {
?><!doctype html>
<html lang="en">
    <head>
        <meta charset="UTF-8">
...
?>
                                    ...
                                    <td>  <form action="listadoProductos.php" method="POST">
                                            <input type="hidden" name="hidden" value="<?php echo $_smarty_tpl->tpl_vars['contact']->value['cod'];?>
">
